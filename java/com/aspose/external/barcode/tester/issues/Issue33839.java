...
@Test(description = "Tests for Issue33839.")
public class Issue33839
{
    private final String folder = Global.getTestDataFolder("Issues" + File.separator + "Issue33839");
    ...
    {
        final String fileName = "DOC00000006.tif";
