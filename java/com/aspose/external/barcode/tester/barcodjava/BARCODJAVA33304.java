...
public class BARCODJAVA33304
{
    ...
    public void testOne()
    {
        ...
        files.add(filePath + "[Untitled]_2202201211071100.tif");
        ...
        for (String fileName : files)
        {
            try
            {
                ...
                BarCodeReader reader = new BarCodeReader(fileName, DecodeType.EAN_13, DecodeType.INTERLEAVED_2_OF_5);
