...
public class BARCODJAVA33234
{
    ...
    public void testOne()
    {
        ...
        files.add(filePath + "I2of5Tools-wizard.gif");
        ...
        for (String fileName : files)
        {
            try
            {
                ...
                BarCodeReader reader = new BarCodeReader(img, DecodeType.INTERLEAVED_2_OF_5);
                ...
                for (BarCodeResult result : reader.readBarCodes())
                {
                    ...
                    Assert.assertEquals(result.getCodeText(), "2063419500");
