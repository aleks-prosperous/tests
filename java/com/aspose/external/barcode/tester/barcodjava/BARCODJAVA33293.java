...
public class BARCODJAVA33293
{
    ...
    public void testOne()
    {
        ...
        files.add(filePath + "barcodeGS1_DatamatrixBytescout.png");
        files.add(filePath + "barcodeGS1DataMatrixTerryburton.png");
        files.add(filePath + "with5_1_GS1.png");
