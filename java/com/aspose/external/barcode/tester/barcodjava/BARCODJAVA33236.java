...
public class BARCODJAVA33236
{
    ...
    public void testOne()
    {
        ...
        files.add(filePath + "5_rotated.JPG");
        ...
        for (String fileName : files)
        {
            try
            {
                ...
                BarCodeReader reader = new BarCodeReader(img, DecodeType.CODE_39_FULL_ASCII);
                ...
                for (BarCodeResult result : reader.readBarCodes())
                {
                    ...
                    Assert.assertEquals(result.getCodeText(), "S7482288F");
