...
public class BARCODJAVA33318
{
    ...
    public void testOne()
    {
        ...
        files.add(filePath + "barcode.png");
        files.add(filePath + "MicroPDF417_2.png");
        files.add(filePath + "MicroPDF417.png");

        for (String fileName : files)
        {
            try
            {
                BarCodeReader reader = new BarCodeReader(fileName, DecodeType.MICRO_PDF_417);
