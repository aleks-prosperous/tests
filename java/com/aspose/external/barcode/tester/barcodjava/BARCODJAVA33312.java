...
public class BARCODJAVA33312
{
    ...
    public void testOne()
    {
        ...
        //s.start();
        String filePath = Global.getBarcodeJavaIssuesTestImagePath("BARCODJAVA33312/");
        List<String> files = new ArrayList<String>();
        files.add(filePath + "00000001.TIF");
        ...
        for (String fileName : files)
        {
            try
            {
                ...
                BarCodeReader reader = new BarCodeReader(fileName, DecodeType.CODE_128, DecodeType.CODE_39_FULL_ASCII);
