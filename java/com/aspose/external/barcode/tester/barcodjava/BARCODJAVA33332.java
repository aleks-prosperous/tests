...
public class BARCODJAVA33332
{
    ...
    public void testOne()
    {
        ...
        files.add(filePath + "tmpbarcode1.png");
        files.add(filePath + "tmpbarcode2.png");
        files.add(filePath + "tmpbarcode3.png");
        files.add(filePath + "tmpbarcode4.png");
