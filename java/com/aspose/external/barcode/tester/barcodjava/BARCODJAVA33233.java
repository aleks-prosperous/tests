    ...
    public void testOne()
    {
        ...
        for (String fileName : files)
        {
            try
            {
                ...
                BarCodeReader reader = new BarCodeReader(img, DecodeType.RM_4_SCC);
                ...
                for (BarCodeResult result : reader.readBarCodes())
                {
                    ...
                    Assert.assertEquals(result.getCodeText(), "345890");
