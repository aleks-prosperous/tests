...
public class BARCODJAVA33237
{
    ...
    public void testOne()
    {
        ...
        files.add(folder + "DatabarOmniDirectional.png");
        ...
        for (String fileName : files)
        {
            try
            {
                ...
                BarcodeGenerator builder = new BarcodeGenerator(EncodeTypes.DATABAR_OMNI_DIRECTIONAL);
                // Set the code text
