        ...
        for (String fileName : files)
        {
            try
            {
                ...
                for (BarCodeResult result : reader.readBarCodes())
                {
                    ...
                    Assert.assertEquals(result.getCodeText(), "MS9XU0QvMDMoRSk7OztBQTBQOTlYMDE4OTs7O0ZTOzs7MS9XU0QvMDMoRSk7OztOOzs7Mzs7O2FiYzs7Ow==");
