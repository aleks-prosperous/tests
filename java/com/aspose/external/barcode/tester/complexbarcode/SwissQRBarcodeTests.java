...
public class SwissQRBarcodeTests
{
    @BeforeMethod
    public void setUp()
    {
    ...
    private SwissQRCodetext minimalValidSwissQR()
    {
    ...
    @Test
    public void SwissQR_Empty_Test()
    {
        SwissQRCodetext swissQRCodetext = new SwissQRCodetext();
    ...
    @Test
    public void SwissQR_PartlyInitialized_Test()
    {
        SwissQRCodetext swissQRCodetext = minimalValidSwissQR();
        ...
        SwissQRCodetext test = ComplexCodetextReader.tryDecodeSwissQR(cr.getFoundBarCodes()[0].getCodeText());
    ...
    @Test
    public void SwissQR_FullyInitialized_Test()
    {
        SwissQRCodetext swissQRCodetext = new SwissQRCodetext();
        swissQRCodetext.getBill().setAccount("CH450023023099999999A");
        ...
        Assert.assertTrue(swissQRCodetext.getBill().equals(test.getBill()));
    }
}
